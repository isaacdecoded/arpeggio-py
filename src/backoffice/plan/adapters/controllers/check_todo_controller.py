...
from backoffice.plan.application.commands import CheckTodoUseCase
...
class CheckTodoController(Controller[RequestObject]):
    def __init__(self, use_case: CheckTodoUseCase):
